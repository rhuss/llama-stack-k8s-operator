...
- [ ] T024f [US1] Implement merge logic: combine user config.yaml + extra-providers.yaml
...
- [ ] T030 [US1] Call MergeRunYaml() during config.yaml generation in controllers/llamastackdistribution_controller.go
