...
func (in *ExternalProvidersSpec) DeepCopyInto(out *ExternalProvidersSpec) {
	*out = *in
	...
	if in.DatasetIO != nil {
		in, out := &in.DatasetIO, &out.DatasetIO
		*out = make([]ExternalProviderRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	...
	if in.PostTraining != nil {
		in, out := &in.PostTraining, &out.PostTraining
		*out = make([]ExternalProviderRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *LlamaStackDistributionStatus) DeepCopyInto(out *LlamaStackDistributionStatus) {
	*out = *in
	...
	if in.ExternalProviderStatus != nil {
		in, out := &in.ExternalProviderStatus, &out.ExternalProviderStatus
		*out = make([]ExternalProviderStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
